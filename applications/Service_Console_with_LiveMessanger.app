...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        <componentList>
            ...
            <components>LiveText_Panel_Hidden</components>
        </componentList>
    ...
    <tabs>LiveText__ITR_Message__c</tabs>
    <tabs>LiveText__Conversation_Header__c</tabs>
    <tabs>MessageLive__c</tabs>
    <tabs>standard-QuickText</tabs>
    <tabs>Option__c</tabs>
    <tabs>LiveText__LiveText_Number__c</tabs>
    <workspaceConfig>
        <mappings>
            <fieldName>LiveText__Contact__c</fieldName>
            <tab>LiveText__Conversation_Header__c</tab>
        </mappings>
        <mappings>
            <tab>LiveText__ITR_Message__c</tab>
        </mappings>
        <mappings>
            <tab>LiveText__LiveText_Number__c</tab>
        </mappings>
        <mappings>
            <tab>MessageLive__c</tab>
        </mappings>
        <mappings>
            <tab>Option__c</tab>
        </mappings>
